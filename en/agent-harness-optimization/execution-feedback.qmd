...
Defining the editable components in the previous chapter is not enough if the failure location is unknown. The system must therefore retain more than a final score: per-input outcomes, sequences of actions and observations, exceptions, and other execution feedback. This chapter explains how to form a hypothesis about the failure location and test it by rerunning a targeted revision.
