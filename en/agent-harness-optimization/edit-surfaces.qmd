...
An edit surface is the set of artifacts and interfaces that an optimizer can rewrite. Calling both an experiment that changes only a prompt and one that changes all runtime code "agent optimization" obscures both what improved and what could break. This chapter organizes the range from prompts to executable runtimes as a continuous hierarchy.
