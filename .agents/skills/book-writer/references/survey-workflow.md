...
- **Figures deferred until later**: a chapter subagent may write only prose and forget figures, creating severe chapter-to-chapter imbalance. **Explicitly require 4–8 figures in the Phase 4 prompt**; see `assets/subagent-prompts/chapter-writer.md`.
